...
function convertDirectory(inputDir, outputDir, options) {
    ...
    options = options || {};
    mp3Quality = typeof options.mp3Quality === "undefined" ? defaultMp3Quality : options.mp3Quality;
    oggQuality = typeof options.oggQuality === "undefined" ? defaultOggQuality : options.oggQuality;
